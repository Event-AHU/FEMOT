...
Download the trained model weights from [[checkpoint_12.pth](https://pan.baidu.com/s/1Mr9kE0Qr5L-PUcxNgZ51WQ?pwd=AHUE)] and put it under `$/outputs/FEMOT/` for testing directly. Please note that training must be run first to generate a configuration file before testing.
